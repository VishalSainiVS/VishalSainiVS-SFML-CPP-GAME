...
public:
	...
	void createAttributeComponent( std::string entity_type);
	...
	virtual const sf::Vector2f getHitboxCenter() const;
	...
	virtual const float getSpriteDistance(const Entity& entity, const Entity& entityy) const;
