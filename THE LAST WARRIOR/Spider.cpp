	...
	: Enemy(enemy_spawner_tile)
{
	...
	this->createHitboxComponent(this->sprite, 17.f, 39.f, 30.f, 30.f);
	this->createMovementComponent(150.f, 800.f, 500.f);
...
void Spider::defferedRenderBar(sf::RenderTarget& target)
{
